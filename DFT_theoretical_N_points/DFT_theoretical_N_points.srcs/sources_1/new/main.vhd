...
begin
    process(clk)
        ...
        variable auxiliar1 : COLLUMN_VECTOR_OUTPUT := (others => (others => ("000000000000000000000000000000000000000000000000")));
        --variable auxiliar1 : COLLUMN_VECTOR := (others => (others => ("000000000000000000000000")));
        variable auxiliar  : Complex_Type_output;
